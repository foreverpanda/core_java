...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		Employee e3=new Employee("rnd-100", "Rama Kher", 10000);
		Employee e4=new Employee("rnd-009", "Anuj Sharma", 12000);
		Employee e5=new Employee("rnd-120", "Anuja Sharma", 15000);		
		//HashSet of emps
		...
		System.out.println("Added "+emps.add(e3));//t hc - 1   eq - 0
		System.out.println("Added "+emps.add(e4));//t hc - 1   eq - 0
		System.out.println("Added "+emps.add(e5));//t hc - 1   eq - 0
