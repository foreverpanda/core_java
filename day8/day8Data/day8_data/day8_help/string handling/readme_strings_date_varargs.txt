...
API
1. java.util.Date--- represents system date & time , till the msec precision
Constructor
1.Date() --- creates Date class instance representing system date, current date.(till ms precision)
2.Date(long msec) --- creates Date class instance representing a date for msec elapsed after epoch(=1st Jan 1970)
